...
from helper_functions.functions_diagnosen import get_prozedur_charlson_pivot
from helper_functions.functions_labor import get_prozedur_labor_pivot_pandas
from helper_functions.functions_prozeduren_labeled import get_prozeduren_for_training
...
def main():
    ...
    proz_lab_pivot = get_prozedur_labor_pivot_pandas(
        df_prozeduren,
        lab_window_in_hours=config.LAB_WINDOW_IN_HOURS,
        variant='complete'
    )
